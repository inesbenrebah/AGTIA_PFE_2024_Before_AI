...
//lehne amalt aka les 3 points eli mn fouk bch kol matetbade el page tetbdel el position taa el nokta
    //donc tamel el  ImageView indicators hasb el itemms el mawjoudin
