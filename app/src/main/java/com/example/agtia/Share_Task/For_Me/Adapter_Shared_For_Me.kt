...
class Adapter_Shared_For_Me (private val list: MutableList<ShareData>, private val emailFrom :String):
    RecyclerView.Adapter<Adapter_Shared_For_Me.ShareViewHolder>() {
    ...
    inner class ShareViewHolder( val binding: SharedForMeBinding) : RecyclerView.ViewHolder(binding.root)
